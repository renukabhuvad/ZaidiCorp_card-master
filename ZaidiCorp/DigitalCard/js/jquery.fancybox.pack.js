...
(function (r, G, f, v) {
        ...
        _afterLoad: function () {
            ...
            if (a && !1 !== b.isActive)
                if (!1 === b.trigger("afterLoad", a, d))
                    ...
                    g = a.href;
                    $("#facebook").attr("href", "https://facebook.com/sharer/sharer.php?u=" + g + "");
                    $("#linkedin").attr("href", "https://www.linkedin.com/shareArticle?mini=true&amp;url=" + g + "");
                    $("#twitter").attr("href", "https://twitter.com/share?url=" + g + "");
                    $("#google").attr("href", "https://plus.google.com/share?url=" + g + "");
                    $("#whatsapp").attr("href", "whatsapp://send?text=" + g + "");
                    $("#instagram").attr("href", "https://instagram.com/?text=" + g + "");
    ...
    b.helpers.overlay = {
        ...
        close: function () {
            ...
            this.el.hasClass("fancybox-lock") && (f(".fancybox-margin").removeClass("fancybox-margin"), a = n.scrollTop(), b = n.scrollLeft(),
                this.el.removeClass("fancybox-lock"), n.scrollTop(a).scrollLeft(b));
